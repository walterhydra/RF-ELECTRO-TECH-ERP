...
const PF01_STAGES_FULL = [
  ...
  { id: 12, code: 'LEG-12',   name: '12. LEGEND PRINT',   department: 'Legend' },
  { id: 13, code: 'HASL-13',  name: '13. HASL',           department: 'Finishing' },
  { id: 14, code: 'HASL-QC',  name: '14. HASL-QC',        department: 'Quality' },

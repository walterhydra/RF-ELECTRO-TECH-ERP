...
const STAGE_OPERATOR_CREDENTIALS = [
  ...
  { order: 12, name: 'HASL', code: 'HASL', email: 'stage12.hasl@rfelectro.com', label: '12. HASL' },
  { order: 13, name: 'HASL-QC', code: 'HASL-QC', email: 'stage13.haslqc@rfelectro.com', label: '13. HASL-QC' },
  { order: 14, name: 'LEGEND PRINT', code: 'LGD', email: 'stage14.legend@rfelectro.com', label: '14. LEGEND PRINT' },
